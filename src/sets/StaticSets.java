...
public class StaticSets {
    ...
    public static Tile[] indoorWallTiles = {StaticTiles.woodPlankWallEndLeftTop, StaticTiles.woodPlankWallEndLeftMid, StaticTiles.woodPlankWallEndLeftBottom, StaticTiles.woodPlankWallMidTop, StaticTiles.woodPlankWallMidMid, StaticTiles.woodPlankWallMidBottom, StaticTiles.woodPlankWallEndRightTop, StaticTiles.woodPlankWallEndRightMid, StaticTiles.woodPlankWallEndRightBottom,
            StaticTiles.woodTileWallEndLeftTop, StaticTiles.woodTileWallEndLeftMid, StaticTiles.woodTileWallEndLeftBottom, StaticTiles.woodTileWallMidTop, StaticTiles.woodTileWallMidMid, StaticTiles.woodTileWallMidBottom, StaticTiles.woodTileWallEndRightTop, StaticTiles.woodTileWallEndRightMid, StaticTiles.woodTileWallEndRightBottom,
            StaticTiles.stripeWallEndLeftTop, StaticTiles.stripeWallEndLeftMid, StaticTiles.stripeWallEndLeftBottom, StaticTiles.stripeWallMidTop, StaticTiles.stripeWallMidMid, StaticTiles.stripeWallMidBottom, StaticTiles.stripeWallEndRightTop, StaticTiles.stripeWallEndRightMid, StaticTiles.stripeWallEndRightBottom,
            StaticTiles.blankWallEndLeftTop, StaticTiles.blankWallEndLeftMid, StaticTiles.blankWallEndLeftBottom, StaticTiles.blankWallMidTop, StaticTiles.blankWallMidMid, StaticTiles.blankWallMidBottom, StaticTiles.blankWallEndRightTop, StaticTiles.blankWallEndRightMid, StaticTiles.blankWallEndRightBottom,
            StaticTiles.shinyWoodFloorLight, StaticTiles.shinyWoodFloorDark, StaticTiles.shinyWoodFloorLeftShadow, StaticTiles.shinyWoodFloorRightShadow, StaticTiles.shinyWoodFloorLeftTopShadow, StaticTiles.shinyWoodFloorLeft, StaticTiles.shinyWoodFloorLeft, StaticTiles.shinyWoodFloorRight, StaticTiles.shinyWoodFloorTopShadow, StaticTiles.shinyWoodFloorTopShadowRightWall, StaticTiles.blackTile};
    ...
    private static SetManager initSetManager() {
        ...
        mgr.addSet("IndoortTiles", indoorWallTiles);
