 ...
 */
public class PKMNMarket extends StaticEntity {
    //Constructors
     ...
     */
    public PKMNMarket(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.PKMNMarket, (int) (x - handler.getGameCamera().getXOffset()), (int) (y - handler.getGameCamera().getYOffset()), width, height, null);
