 ...
 */
public class BigStore extends StaticEntity {
    //Constructors
     ...
     */
    public BigStore(Handler handler, float x, float y) {
        super(handler, x, y, Tile.TILE_WIDTH * 5, Tile.TILE_HEIGHT * 5);
        bounds.x = Tile.TILE_WIDTH / 2;
        bounds.y = (int) (1.5 * Tile.TILE_HEIGHT);
        bounds.width = (int) (width - 0.75 * Tile.TILE_WIDTH);
        bounds.height = (int) (height - 1.75 * Tile.TILE_HEIGHT);
    }
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.bigStore, (int) (x - handler.getGameCamera().getXOffset()), (int) (y - handler.getGameCamera().getYOffset()), width, height, null);
