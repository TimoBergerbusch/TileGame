 ...
 */
public class DoubleHouseRed extends StaticEntity {
    //Constructors
     ...
     */
    public DoubleHouseRed(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.doubleHouseRed, (int) (x - handler.getGameCamera().getXOffset()), (int) (y - handler.getGameCamera().getYOffset()), width, height, null);
