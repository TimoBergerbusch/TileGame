 ...
 */
public class DoubleHouseBaige extends StaticEntity {
    //Constructors
     ...
     */
    public DoubleHouseBaige(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.doubleHouseBaige, (int) (x - handler.getGameCamera().getXOffset()), (int) (y - handler.getGameCamera().getYOffset()), width, height, null);
