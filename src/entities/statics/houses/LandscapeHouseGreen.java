 ...
 */
public class LandscapeHouseGreen extends StaticEntity {
    //Constructors
     ...
     */
    public LandscapeHouseGreen(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.landscapeHouseGreen, (int) (x - handler.getGameCamera().getXOffset()), (int) (y - handler.getGameCamera().getYOffset()), width, height, null);
