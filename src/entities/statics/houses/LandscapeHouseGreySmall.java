...
public class LandscapeHouseGreySmall extends StaticEnterAbleEntity {
     ...
     */
    public LandscapeHouseGreySmall(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.landscapeHouseGreySmall, (int) (x - handler.getGameCamera().getXOffset()), (int) (y - handler.getGameCamera().getYOffset()), width, height, null);
